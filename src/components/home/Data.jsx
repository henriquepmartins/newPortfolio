...
const Data = () => {
    return (
       <div className="home__data">
        Hey, I'm
        <h1 className="home__title">Henrique Martins
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Getting deeper in Java development, showcasing a passion for problem-solving and collaboration in software development.</p>
       <br />
